...
import { fetchCoffeeStore, fetchCoffeeStores } from '@/lib/fetchCoffeeStores';
...
export async function generateStaticParams() {
  //map CoffeeStore id´s
  const osnaLongLat = "8.047226311740104%2C52.273543912983"
  const coffeeStores = await fetchCoffeeStores(osnaLongLat, 6);
...
export async function generateMetadata({ params, searchParams }: ServerParamsType) {
  ...
  return {
    ...
    alternates: {
      canonical: `/coffeeStore/${params.id}`,
    },
  };
